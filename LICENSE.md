...
The **Building and Publishing Node.js Applications with Windows Azure Web Sites (OS X) Hands-on Lab** is licensed under the terms of the Apache License, Version 2.0.
